...
This fork fixes `TypeError: Cannot read property 'bundleHash' of null` error for non-Flashbots builder RPCs as most of them don't return bundle hashes. There's a [corresponding PR](https://github.com/flashbots/ethers-provider-flashbots-bundle/pull/97) in the parent repo.
